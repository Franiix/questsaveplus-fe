const en = {
 ...
 home: {
  ...
  firstRunOnboarding: {
   eyebrow: 'Welcome to QuestSave+',
   title: 'Setup complete',
   subtitle: "Three quick beats and you're in the flow.",
   skip: 'Skip',
   next: 'Next',
   finish: 'Let’s go',
   slides: {
    backlog: {
     eyebrow: 'Backlog',
     title: 'Save the games you want to keep in sight',
     subtitle:
      'Organize everything by status, rating, notes, and played platforms without losing the thread.',
     chips: ['Smart status', 'Quick ratings', 'Notes and platforms'],
    },
    playNext: {
     eyebrow: 'Play Next',
     title: 'Build the queue for your next run',
     subtitle:
      'Pin the titles you want to play soon, reorder them, and keep your next session ready.',
     chips: ['Quick pinning', 'Manual order', 'Run focus'],
    },
    archive: {
     eyebrow: 'Archive',
     title: 'Store what you do not want in the active flow',
     subtitle:
      'Archive a game without deleting it: it stays saved, but leaves the active backlog until you restore it.',
     chips: ['Less clutter', 'Everything saved', 'Fast restore'],
    },
   },
  },
 },
 ...
 backlog: {
  ...
  releaseValidation: {
   ...
   startedBeforeRelease: 'The start date cannot be earlier than the game release date.',
  },
 ...
 social: {
  mySnapshot: 'My backlog',
  timelineTitle: 'Completed games',
  timelineShowAll: 'Show all ({{count}} more)',
  searchTitle: 'Search players',
  searchPlaceholder: 'Search players…',
  searchEmpty: 'No users found.',
  friendsTitle: 'Friends',
  requestsTitle: 'Requests',
  noFriends: 'No friends yet. Search for other players!',
  addFriend: 'Add',
  ...
  friendProfileTagline: 'Player profile',
  showMoreFriends: 'Show more ({{count}})',
  revokeRequest: 'Revoke',
  myStatsTitle: 'My statistics',
  myStatsSubtitle: 'Your up-to-date snapshot: games in the backlog, progress, and ratings.',
  playingTitle: 'Playing',
  ongoingTitle: 'Ongoing',
  wantToPlayTitle: 'Want to play',
  abandonedTitle: 'Abandoned',
  showMoreItems: 'Show more ({{count}})',
  subtitle: 'Connect with other players and compare your backlogs.',
  sentRequestsTitle: 'Sent requests',
  sentRequestsEmpty: 'No sent requests.',
  sentRequestsButton: 'Sent requests ({{count}})',
  sortLabel: 'Sort friends',
  sortRecent: 'Most recent',
  sortOldest: 'Least recent',
