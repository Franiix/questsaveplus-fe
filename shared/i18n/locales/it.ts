const it = {
 ...
 social: {
  mySnapshot: 'Il mio backlog',
  timelineTitle: 'Completamenti',
  timelineShowAll: 'Mostra tutti ({{count}} altri)',
  searchTitle: 'Cerca giocatori',
  searchPlaceholder: 'Cerca videogiocatori…',
  searchEmpty: 'Nessun utente trovato.',
  friendsTitle: 'Amici',
  requestsTitle: 'Richieste',
  noFriends: 'Nessun amico ancora. Cerca altri videogiocatori!',
  addFriend: 'Aggiungi',
  ...
  removeFriendSuccess: 'Amico rimosso.',
  removeFriendConfirm: 'Sei sicuro di voler rimuovere questo amico?',
  friendSince: 'Amici dal {{date}}',
  friendProfileTagline: 'Profilo giocatore',
  showMoreFriends: 'Mostra altri ({{count}})',
  revokeRequest: 'Revoca',
  myStatsTitle: 'Le mie statistiche',
  myStatsSubtitle: 'Il tuo snapshot aggiornato: giochi nel backlog, avanzamento e valutazioni.',
  playingTitle: 'In corso',
  ongoingTitle: 'Ricorrenti',
  wantToPlayTitle: 'Da giocare',
  abandonedTitle: 'Abbandonati',
  showMoreItems: 'Mostra altri ({{count}})',
  subtitle: 'Connettiti con altri giocatori e confronta i vostri backlog.',
  sentRequestsTitle: 'Richieste inviate',
  sentRequestsEmpty: 'Nessuna richiesta inviata.',
  sentRequestsButton: 'Richieste inviate ({{count}})',
  sortLabel: 'Ordina amici',
